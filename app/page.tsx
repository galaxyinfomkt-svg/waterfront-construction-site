...
export const metadata = pageMeta({
  ...
  description: "Home remodeling & construction in Northborough & MetroWest, MA — kitchens, baths, siding, additions, decks & full remodels. Licensed, insured · free estimates.",
  path: "/",
  absoluteTitle: true,
});
    ...
    <>
        ...
        <div className="relative container-x py-16 md:py-24 grid lg:grid-cols-[1.1fr_.9fr] gap-12 items-center">
          <div className="text-white reveal">
            <div className="flex flex-wrap items-center gap-2.5">
              ...
              <span className="inline-flex items-center gap-2 rounded-full bg-cyan/20 border border-cyan/40 px-4 py-1.5 text-sm backdrop-blur">🏗️ Owner-led local team</span>
            </div>
      ...
      <section className="bg-white border-b border-sand">
        <div className="container-x py-6 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-navy/70 font-semibold text-sm">
          ...
          <span>📍 Based in Northborough, MA</span>
